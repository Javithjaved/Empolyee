        ...
        <>
            <nav className="navbar navbar-expand-lg box">
                <div className="container-fluid ">
                    ...
                    <div>
                        <div className="btn-group dropdown  d-block d-sm-block d-md-none me-3 ">
                            ...
                            <ul className="dropdown-menu ">
                                ...
                                <li style={{cursor :"pointer"}}><p className="dropdown-item a2" ><span className="textcolor1 text-decoration-none"  onClick={() => { window.location.href = "/"; localStorage.removeItem('accessToken'); localStorage.removeItem("refreshToken"); setIsSignedIn(false) }}>Sign Out</span></p></li>
                            </ul>
                            </div>
                        </div>
                        <div className="btn-group dropdown d-none d-sm-none d-md-block ">
                            <button type="button" className="btn  dropdown-toggle border-0" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src={Photo1} className="rounded-pill" alt="adminPhoto" width="30" height="30" />
                                <span className="cname  me-3 ms-2"> Admin</span>
                            </button>
                            <div>
                            <ul className="dropdown-menu">
                                <li><p className="dropdown-item "><span className="textcolor1">Action</span></p></li>
                                <li><p className="dropdown-item"><span className="textcolor1">Another Action</span></p></li>
                                <li><hr className="dropdown-divider" /></li>
                                <li><p className="dropdown-item a2" ><span className="textcolor1 text-decoration-none" onClick={() => { localStorage.removeItem('accessToken'); localStorage.removeItem("refreshToken"); setIsSignedIn(false) }}>Sign Out</span></p></li>
                            </ul>
                            </div>
                        </div>
                    </div>
