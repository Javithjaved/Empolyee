    ...
    return (
        <>
            <div className=" list-group sidebar">
                ...
                <p className="list-group-item list-group-item-action home p-3 " onClick={() => Navigate("/fts-new-user")}><Icon className="icon" icon="solar:user-bold-duotone" /> FTS New User <span className="unicode">&#10095;</span></p>
