        ...
        <>
            <div className="container-fluid p-0">
                <div className="row ">
                    ...
                    <div className="col-sm-12 col-md-10 col-xl-10 backgroundcolor ps-3">
                        <div className="backgroundcolorinnerbox rounded-bottom-4 p-3">
                            <h5 className="header1">Education Details</h5>
                            <hr></hr>
                            <div className="row">
                            ...
                            <div className="About">
                                <div className="col-xl-12 col-sm-12 col-lg-6 col-md-6">
                            ...
                            <div className="text-end">
                                <div className="col-12 pb-3 ">
                                    <button type="button " onClick={() => Navigate('/Employee')} className="btn btn-danger button me-3">Cancel</button>
                                    <button type="button " className="btn btn-danger button  " onClick={(e) => handleChangeSubmit(e)}>Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
