            ...
            <div className="bg6">            
                    ...
                    <div className="row">
                        ...
                        <div className="col-10 mt-2">
                            <div className="row">
                            <div className="col-12 "><h5 className="label2 ms-4 mt-2">Employee Data</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="col-2 pt-3 pe-5  text-end  " href=""><span  className="add" onClick={TableAdd}><Icon icon="zondicons:add-solid" /></span><span className="add"> Add</span></div>
                            </div>  
                            <div className="tb">
                                <div className="row">
